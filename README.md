...
### 2) Creating Professional Dashboard using Power BI
...
- Built an interactive dashboard to explore performance trends and filter insights dynamically.
...
### Creating Professional Dashboard using Power BI
...
- Gauge analysis highlights models exceeding efficiency targets, making them strong candidates for eco-conscious consumers and fleet optimization.
